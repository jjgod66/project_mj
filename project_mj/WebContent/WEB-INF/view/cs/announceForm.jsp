							...
							<table id="example1"
								...
								<tbody>
									<%
										...
										int bd_no = anVo.getBd_no();
									%>
									<tr>
										<td><a
											href="<%=request.getContextPath()%>/cs/announceView.do?bd_no=<%=bd_no%>"><%=bd_title%></a>
										</td>
									</tr>
									<%
										}
							...
							<div class="col-sm-12">
								<table id="example1"
									...
									<tbody>
										...
										<tr>
											<td><a
												href="<%=request.getContextPath()%>/cs/announceForm.do"><%=anVo.getBd_title()%></a>
											</td>
										</tr>
										<%
											}
