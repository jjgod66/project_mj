							...
							<li>
								...
								<div class="aa-product-hvr-content">
									<a href="#" data-toggle="tooltip" data-placement="top" title=""
										...
										class="fa fa-heart-o"></span></a> <a href="#"
				...
				<aside class="aa-sidebar">
					...
					<div class="aa-sidebar-widget">
						...
						<div class="aa-sidebar-price-range">
							<form action="">
								...
								<span id="skip-value-lower" class="example-val">20.00</span> <span
									id="skip-value-upper" class="example-val">70.00</span>
					...
					<div class="aa-sidebar-widget">
						...
						<div class="aa-color-tag">
							<a class="aa-color-green" href="#"></a> <a
								class="aa-color-yellow" href="#"></a> <a class="aa-color-pink"
								href="#"></a> <a class="aa-color-purple" href="#"></a> <a
								class="aa-color-blue" href="#"></a> <a class="aa-color-orange"
								href="#"></a> <a class="aa-color-gray" href="#"></a> <a
								class="aa-color-black" href="#"></a> <a class="aa-color-white"
								href="#"></a> <a class="aa-color-cyan" href="#"></a> <a
								class="aa-color-olive" href="#"></a> <a class="aa-color-orchid"
								href="#"></a>
						</div>
					</div>
					<!-- single sidebar -->
